...
import { AppContextType, IUser, SellProductInfoType } from '@/interFace/interFace';
import axios from 'axios';
import { useDispatch } from 'react-redux';
import { ProductType, TeamMember, blogDataType } from '@/interFace/api-interFace';
...
const AppProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    // wishlist states
    const [showSidebarWishlist, setShowSidebarWishlist] = useState<boolean>(false);
