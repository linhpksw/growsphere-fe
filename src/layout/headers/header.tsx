...
import whiteLogo from '../../../public/assets/img/logo/horizontal-light.svg';
import blackLogo from '../../../public/assets/img/logo/horizontal-dark.svg';
                                            ...
                                            <div className="bd-header__right header__right-2">
                                                <div className="bd-action__cart-list justify-content-end">
                                                    ...
                                                    <div className="bd-action__item d-sm-flex align-items-center">
                                                        {user?.email ? (
                                                            <>
                                                                <div className="bd-action__cart me-2">
