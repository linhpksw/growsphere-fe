...
const ShopSidebarCategories = () => {
    ...
    const { setProducts, setotalPages, setcurrentPage, limit, setPage, page } = useGlobalContext();
    ...
    }, [searchValue, setProducts, setotalPages, setcurrentPage, page, limit, setPage]);
            ...
            <div className="bd-filter__widget child-content-hidden">
                ...
                <div className="bd-filter__content">
                    <div onClick={handleViewAll} className="bd-singel__rating">
                        <input className="radio-box" type="radio" id="view-all-1" name="rating" />
